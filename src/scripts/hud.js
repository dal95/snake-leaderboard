...
export function showLoadingScreen () {
  ...
  axios.put(`https://games-staging.pmisg.cloud.sg/pmi-backoffice/public/api/gameplay2021/completed/${state._current_id}`, {
    score: state.SCORE
  })
    .then(res => {
      showFinalScore()
...
export function showLeaderboard () {
  ...
  axios.get(`https://games-staging.pmisg.cloud.sg/pmi-backoffice/public/api/gameplay2021/leaderboard/snake-leaderboard?query=${query}`)
    .then(res => {
      renderLeaderboard('#leaderboard .ldb-list', res.data.leaderboard_list)
